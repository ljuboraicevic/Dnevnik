 ...
 * @author ljubo
 */
public class dProfesoriDodavanje extends javax.swing.JDialog {
    ...
    private void dodajProfesora(
            ...
            fLog.CB.izvrsiQueryBezRezultata(
                "INSERT INTO profesor VALUES ($next_id,'"+sIme+"','"+sPrezime+"','"
     ...
     */
    public dProfesoriDodavanje(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        btnDodajProfesora.setText("Dodaj profesora");
    ...
    private void btnDodajProfesoraActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDodajProfesoraActionPerformed
        ...
        this.dodajProfesora(tfIme.getText(), tfPrezime.getText(),
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(dProfesoriDodavanje.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                dProfesoriDodavanje dialog = new dProfesoriDodavanje(new javax.swing.JFrame(), true);
